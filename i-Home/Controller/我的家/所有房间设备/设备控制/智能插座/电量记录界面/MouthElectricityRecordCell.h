...
#import "XJYChart.h"
static NSString* kMouthElectricityRecordCell = @"MouthElectricityRecordCell";
NS_ASSUME_NONNULL_BEGIN

@interface MouthElectricityRecordCell : UITableViewCell

...
- (UIButton *)commitButton {
    if (_commitButton == nil) {
        ...
        NSAttributedString *str = [[NSAttributedString alloc]initWithString:Localized(@"Finish") attributes:self.titleAttributes];
...
- (UIButton *)cancelButton {
    if (_cancelButton == nil) {
        ...
        NSAttributedString *str = [[NSAttributedString alloc]initWithString:Localized(@"Cancel") attributes:self.titleAttributes];

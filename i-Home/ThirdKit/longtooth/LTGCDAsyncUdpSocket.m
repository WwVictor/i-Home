...
@class LTGCDAsyncUdpSendPacket;

NSString *const LTGCDAsyncUdpSocketException = @"LTGCDAsyncUdpSocketException";
NSString *const LTGCDAsyncUdpSocketErrorDomain = @"LTGCDAsyncUdpSocketErrorDomain";

NSString *const LTGCDAsyncUdpSocketQueueName = @"LTGCDAsyncUdpSocket";
NSString *const LTGCDAsyncUdpSocketThreadName = @"LTGCDAsyncUdpSocket-CFStream";

enum LTGCDAsyncUdpSocketFlags
{
...
enum LTGCDAsyncUdpSocketConfig
{
...
@interface LTGCDAsyncUdpSocket ()
{
	...
	LTGCDAsyncUdpSocketReceiveFilterBlock receiveFilterBlock;
	dispatch_queue_t receiveFilterQueue;
	BOOL receiveFilterAsync;
	
	LTGCDAsyncUdpSocketSendFilterBlock sendFilterBlock;
	...
	LTGCDAsyncUdpSendPacket *currentSend;
...
**/
@interface LTGCDAsyncUdpSendPacket : NSObject {
@public
	NSData *buffer;
...
@implementation LTGCDAsyncUdpSendPacket
...
@interface LTGCDAsyncUdpSpecialPacket : NSObject {
@public
//	uint8_t type;
...
@implementation LTGCDAsyncUdpSpecialPacket
...
@implementation LTGCDAsyncUdpSocket
...
- (id)initWithDelegate:(id <LTGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq
{
	LogTrace();
...
- (id)initWithDelegate:(id <LTGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	LogTrace();
	...
	if ((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([LTGCDAsyncUdpSocketQueueName UTF8String], NULL);
		}
...
- (void)setDelegate:(id <LTGCDAsyncUdpSocketDelegate>)newDelegate synchronously:(BOOL)synchronously
{
...
- (void)setDelegate:(id <LTGCDAsyncUdpSocketDelegate>)newDelegate
{
	[self setDelegate:newDelegate synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <LTGCDAsyncUdpSocketDelegate>)newDelegate
{
...
- (void)getDelegate:(id <LTGCDAsyncUdpSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (void)setDelegate:(id <LTGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue synchronously:(BOOL)synchronously
{
	dispatch_block_t block = ^{
...
- (void)setDelegate:(id <LTGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
	[self setDelegate:newDelegate delegateQueue:newDelegateQueue synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <LTGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:LTGCDAsyncUdpSocketErrorDomain
	                           code:LTGCDAsyncUdpSocketBadConfigError
	                       userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:LTGCDAsyncUdpSocketErrorDomain
	                           code:LTGCDAsyncUdpSocketBadParamError
	                       userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"LTGCDAsyncUdpSocketSendTimeoutError",
	                                                     @"LTGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Send operation timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:LTGCDAsyncUdpSocketErrorDomain
	                           code:LTGCDAsyncUdpSocketSendTimeoutError
	                       userInfo:userInfo];
}

- (NSError *)socketClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"LTGCDAsyncUdpSocketClosedError",
	                                                     @"LTGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Socket closed", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:LTGCDAsyncUdpSocketErrorDomain code:LTGCDAsyncUdpSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:LTGCDAsyncUdpSocketErrorDomain
	                           code:LTGCDAsyncUdpSocketOtherError
	                       userInfo:userInfo];
}
...
- (BOOL)connectToHost:(NSString *)host onPort:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		LTGCDAsyncUdpSpecialPacket *packet = [[LTGCDAsyncUdpSpecialPacket alloc] init];
...
- (void)maybeConnect
{
	...
	BOOL sendQueueReady = [currentSend isKindOfClass:[LTGCDAsyncUdpSpecialPacket class]];
	
	if (sendQueueReady)
	{
		LTGCDAsyncUdpSpecialPacket *connectPacket = (LTGCDAsyncUdpSpecialPacket *)currentSend;
...
- (void)sendData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	LTGCDAsyncUdpSendPacket *packet = [[LTGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (void)sendData:(NSData *)data toAddress:(NSData *)remoteAddr withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	LTGCDAsyncUdpSendPacket *packet = [[LTGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
	packet->addressFamily = [LTGCDAsyncUdpSocket familyFromAddress:remoteAddr];
...
- (void)setSendFilter:(LTGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setSendFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setSendFilter:(LTGCDAsyncUdpSocketSendFilterBlock)filterBlock
            withQueue:(dispatch_queue_t)filterQueue
       isAsynchronous:(BOOL)isAsynchronous
{
	LTGCDAsyncUdpSocketSendFilterBlock newFilterBlock = NULL;
...
- (void)maybeDequeueSend
{
	...
	if (currentSend == nil)
	{
		...
		while ([sendQueue count] > 0)
		{
			...
			if ([currentSend isKindOfClass:[LTGCDAsyncUdpSpecialPacket class]])
			{
				[self maybeConnect];
...
- (void)doPreSend
{
	...
	if (sendFilterBlock && sendFilterQueue)
	{
		...
		if (sendFilterAsync)
		{
			...
			LTGCDAsyncUdpSendPacket *sendPacket = currentSend;
...
- (void)setReceiveFilter:(LTGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setReceiveFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setReceiveFilter:(LTGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous
{
	LTGCDAsyncUdpSocketReceiveFilterBlock newFilterBlock = NULL;
	dispatch_queue_t newFilterQueue = NULL;
...
+ (void)listenerThread
{
	@autoreleasepool {
		...
		[[NSThread currentThread] setName:LTGCDAsyncUdpSocketThreadName];
...
+ (void)addStreamListener:(LTGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
...
+ (void)removeStreamListener:(LTGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == listenerThread, @"Invoked on wrong thread");
...
{
	@autoreleasepool {
		LTGCDAsyncUdpSocket *asyncUdpSocket = (__bridge LTGCDAsyncUdpSocket *)pInfo;

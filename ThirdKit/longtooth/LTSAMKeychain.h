...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, LTSAMKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	LTSAMKeychainErrorBadArguments = -1001,
};

/** SAMKeychain error domain */
extern NSString *const LTkSAMKeychainErrorDomain;

/** Account name. */
extern NSString *const LTkSAMKeychainAccountKey;
 ...
 */
extern NSString *const LTkSAMKeychainCreatedAtKey;

/** Item class. */
extern NSString *const LTkSAMKeychainClassKey;

/** Item description. */
extern NSString *const LTkSAMKeychainDescriptionKey;

/** Item label. */
extern NSString *const LTkSAMKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const LTkSAMKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const LTkSAMKeychainWhereKey;
 ...
 */
@interface LTSAMKeychain : NSObject

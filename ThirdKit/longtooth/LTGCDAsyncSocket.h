...
@class LTGCDAsyncReadPacket;
@class LTGCDAsyncWritePacket;
@class LTGCDAsyncSocketPreBuffer;
@protocol LTGCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const LTGCDAsyncSocketException;
extern NSString *const LTGCDAsyncSocketErrorDomain;

extern NSString *const LTGCDAsyncSocketQueueName;
extern NSString *const LTGCDAsyncSocketThreadName;

extern NSString *const LTGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const LTGCDAsyncSocketUseCFStreamForTLS;
#endif
#define LTGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define LTGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define LTGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const LTGCDAsyncSocketSSLPeerID;
extern NSString *const LTGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const LTGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const LTGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const LTGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const LTGCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const LTGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define LTGCDAsyncSocketLoggingContext 65535


typedef NS_ENUM(NSInteger, LTGCDAsyncSocketError) {
	LTGCDAsyncSocketNoError = 0,           // Never used
	LTGCDAsyncSocketBadConfigError,        // Invalid configuration
	LTGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	LTGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	LTGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	LTGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	LTGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	LTGCDAsyncSocketClosedError,           // The remote peer closed the connection
	LTGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface LTGCDAsyncSocket : NSObject
...
- (instancetype)initWithDelegate:(nullable id<LTGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<LTGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<LTGCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<LTGCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<LTGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<LTGCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<LTGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
@protocol LTGCDAsyncSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(LTGCDAsyncSocket *)sock;
...
**/
- (void)socket:(LTGCDAsyncSocket *)sock didAcceptNewSocket:(LTGCDAsyncSocket *)newSocket;

/**
 * Called when a socket connects and is ready for reading and writing.
 * The host parameter will be an IP address, not a DNS name.
**/
- (void)socket:(LTGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port;

/**
 * Called when a socket connects and is ready for reading and writing.
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(LTGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;

/**
 * Called when a socket has completed reading the requested data into memory.
 * Not called if there is an error.
**/
- (void)socket:(LTGCDAsyncSocket *)sock didReadData:(NSData *)data withTag:(long)tag;
...
**/
- (void)socket:(LTGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(LTGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(LTGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(LTGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(LTGCDAsyncSocket *)sock;
...
**/
- (void)socketDidDisconnect:(LTGCDAsyncSocket *)sock withError:(nullable NSError *)err;
...
**/
- (void)socketDidSecure:(LTGCDAsyncSocket *)sock;
...
**/
- (void)socket:(LTGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust

...
#ifndef LTGCDAsyncSocketLoggingEnabled
#define LTGCDAsyncSocketLoggingEnabled 0
#endif

#if LTGCDAsyncSocketLoggingEnabled
...
#define LogAsync   YES
#define LogContext LTGCDAsyncSocketLoggingContext
...
#ifndef LTGCDAsyncSocketLogLevel
#define LTGCDAsyncSocketLogLevel LOG_LEVEL_VERBOSE
#endif

// Log levels : off, error, warn, info, verbose
static const int logLevel = LTGCDAsyncSocketLogLevel;
...
NSString *const LTGCDAsyncSocketException = @"LTGCDAsyncSocketException";
NSString *const LTGCDAsyncSocketErrorDomain = @"LTGCDAsyncSocketErrorDomain";

NSString *const LTGCDAsyncSocketQueueName = @"LTGCDAsyncSocket";
NSString *const LTGCDAsyncSocketThreadName = @"LTGCDAsyncSocket-CFStream";

NSString *const LTGCDAsyncSocketManuallyEvaluateTrust = @"LTGCDAsyncSocketManuallyEvaluateTrust";
#if TARGET_OS_IPHONE
NSString *const LTGCDAsyncSocketUseCFStreamForTLS = @"LTGCDAsyncSocketUseCFStreamForTLS";
#endif
NSString *const LTGCDAsyncSocketSSLPeerID = @"LTGCDAsyncSocketSSLPeerID";
NSString *const LTGCDAsyncSocketSSLProtocolVersionMin = @"LTGCDAsyncSocketSSLProtocolVersionMin";
NSString *const LTGCDAsyncSocketSSLProtocolVersionMax = @"LTGCDAsyncSocketSSLProtocolVersionMax";
NSString *const LTGCDAsyncSocketSSLSessionOptionFalseStart = @"LTGCDAsyncSocketSSLSessionOptionFalseStart";
NSString *const LTGCDAsyncSocketSSLSessionOptionSendOneByteRecord = @"LTGCDAsyncSocketSSLSessionOptionSendOneByteRecord";
NSString *const LTGCDAsyncSocketSSLCipherSuites = @"LTGCDAsyncSocketSSLCipherSuites";
#if !TARGET_OS_IPHONE
NSString *const LTGCDAsyncSocketSSLDiffieHellmanParameters = @"LTGCDAsyncSocketSSLDiffieHellmanParameters";
#endif

enum LTGCDAsyncSocketFlags
{
...
@interface LTGCDAsyncSocketPreBuffer : NSObject
{
	uint8_t *preBuffer;
...
@implementation LTGCDAsyncSocketPreBuffer
...
**/
@interface LTGCDAsyncReadPacket : NSObject
{
  @public
...
- (NSUInteger)readLengthForTermWithPreBuffer:(LTGCDAsyncSocketPreBuffer *)preBuffer found:(BOOL *)foundPtr;

- (NSInteger)searchForTermAfterPreBuffering:(ssize_t)numBytes;

@end

@implementation LTGCDAsyncReadPacket
...
**/
@interface LTGCDAsyncWritePacket : NSObject
{
  @public
	NSData *buffer;
	NSUInteger bytesDone;
...
@implementation LTGCDAsyncWritePacket
...
**/
@interface LTGCDAsyncSpecialPacket : NSObject
{
  @public
...
@implementation LTGCDAsyncSpecialPacket
...
@implementation LTGCDAsyncSocket
{
	uint32_t flags;
	uint16_t config;
	
	__weak id<LTGCDAsyncSocketDelegate> delegate;
	...
	LTGCDAsyncReadPacket *currentRead;
	LTGCDAsyncWritePacket *currentWrite;
	
	unsigned long socketFDBytesAvailable;
	
	LTGCDAsyncSocketPreBuffer *preBuffer;
	...
	LTGCDAsyncSocketPreBuffer *sslPreBuffer;
...
- (id)initWithDelegate:(id<LTGCDAsyncSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	if((self = [super init]))
	{
		delegate = aDelegate;
		...
		{
			socketQueue = dispatch_queue_create([LTGCDAsyncSocketQueueName UTF8String], NULL);
		}
		...
		preBuffer = [[LTGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
- (void)getDelegate:(id<LTGCDAsyncSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (BOOL)acceptOnInterface:(NSString *)inInterface port:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		if (enableIPv4)
		{
			...
			__weak LTGCDAsyncSocket *weakSelf = self;
			
			dispatch_source_set_event_handler(accept4Source, ^{ @autoreleasepool {
			#pragma clang diagnostic push
			#pragma clang diagnostic warning "-Wimplicit-retain-self"
				
				__strong LTGCDAsyncSocket *strongSelf = weakSelf;
...
- (BOOL)doAccept:(int)parentSocketFD
{
	...
	if (delegateQueue)
	{
		...
		dispatch_async(delegateQueue, ^{ @autoreleasepool {
			...
			LTGCDAsyncSocket *acceptedSocket = [[[self class] alloc] initWithDelegate:theDelegate
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:LTGCDAsyncSocketErrorDomain code:LTGCDAsyncSocketBadConfigError userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:LTGCDAsyncSocketErrorDomain code:LTGCDAsyncSocketBadParamError userInfo:userInfo];
}
...
- (NSError *)connectTimeoutError
{
	...
	return [NSError errorWithDomain:LTGCDAsyncSocketErrorDomain code:LTGCDAsyncSocketConnectTimeoutError userInfo:userInfo];
}
...
- (NSError *)readMaxedOutError
{
	...
	return [NSError errorWithDomain:LTGCDAsyncSocketErrorDomain code:LTGCDAsyncSocketReadMaxedOutError userInfo:info];
}
...
- (NSError *)readTimeoutError
{
	...
	return [NSError errorWithDomain:LTGCDAsyncSocketErrorDomain code:LTGCDAsyncSocketReadTimeoutError userInfo:userInfo];
}
...
- (NSError *)writeTimeoutError
{
	...
	return [NSError errorWithDomain:LTGCDAsyncSocketErrorDomain code:LTGCDAsyncSocketWriteTimeoutError userInfo:userInfo];
}
...
- (NSError *)connectionClosedError
{
	...
	return [NSError errorWithDomain:LTGCDAsyncSocketErrorDomain code:LTGCDAsyncSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:LTGCDAsyncSocketErrorDomain code:LTGCDAsyncSocketOtherError userInfo:userInfo];
}
                        ...
                        tag:(long)tag
{
	...
	LTGCDAsyncReadPacket *packet = [[LTGCDAsyncReadPacket alloc] initWithData:buffer
	                                                          startOffset:offset
	                                                            maxLength:length
	                                                              timeout:timeout
	                                                           readLength:0
...
- (float)progressOfReadReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentRead || ![currentRead isKindOfClass:[LTGCDAsyncReadPacket class]])
		{
...
- (void)maybeDequeueRead
{
	...
	if ((currentRead == nil) && (flags & kConnected))
	{
		if ([readQueue count] > 0)
		{
			...
			if ([currentRead isKindOfClass:[LTGCDAsyncSpecialPacket class]])
			{
...
- (void)completeCurrentRead
{
	...
	{
		LTGCDAsyncReadPacket *theRead = currentRead; // Ensure currentRead retained since result may not own buffer
...
- (void)doReadTimeout
{
	...
	{
		LTGCDAsyncReadPacket *theRead = currentRead;
...
- (void)writeData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	LTGCDAsyncWritePacket *packet = [[LTGCDAsyncWritePacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (float)progressOfWriteReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentWrite || ![currentWrite isKindOfClass:[LTGCDAsyncWritePacket class]])
		{
...
- (void)maybeDequeueWrite
{
	...
	if ((currentWrite == nil) && (flags & kConnected))
	{
		if ([writeQueue count] > 0)
		{
			...
			if ([currentWrite isKindOfClass:[LTGCDAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued GCDAsyncSpecialPacket");
...
- (void)doWriteTimeout
{
	...
	{
		LTGCDAsyncWritePacket *theWrite = currentWrite;
...
- (void)startTLS:(NSDictionary *)tlsSettings
{
	...
	LTGCDAsyncSpecialPacket *packet = [[LTGCDAsyncSpecialPacket alloc] initWithTLSSettings:tlsSettings];
...
- (void)maybeStartTLS
{
	...
	if ((flags & kStartingReadTLS) && (flags & kStartingWriteTLS))
	{
		...
		#if TARGET_OS_IPHONE
		{
			LTGCDAsyncSpecialPacket *tlsPacket = (LTGCDAsyncSpecialPacket *)currentRead;
            NSDictionary *tlsSettings = @{};
            if (tlsPacket) {
                tlsSettings = tlsPacket->tlsSettings;
            }
			NSNumber *value = [tlsSettings objectForKey:LTGCDAsyncSocketUseCFStreamForTLS];
...
{
	LTGCDAsyncSocket *asyncSocket = (__bridge LTGCDAsyncSocket *)connection;
...
- (void)ssl_startTLS
{
	...
	BOOL shouldManuallyEvaluateTrust = [[tlsSettings objectForKey:LTGCDAsyncSocketManuallyEvaluateTrust] boolValue];
	...
	value = [tlsSettings objectForKey:LTGCDAsyncSocketSSLPeerID];
	...
	{
		NSAssert(NO, @"Invalid value for LTGCDAsyncSocketSSLPeerID. Value must be of type NSData."
		             @" (You can convert strings to data using a method like"
		             @" [string dataUsingEncoding:NSUTF8StringEncoding])");
		
		[self closeWithError:[self otherError:@"Invalid value for LTGCDAsyncSocketSSLPeerID."]];
		return;
	}
	
	// 4. GCDAsyncSocketSSLProtocolVersionMin
	
	value = [tlsSettings objectForKey:LTGCDAsyncSocketSSLProtocolVersionMin];
	...
	{
		NSAssert(NO, @"Invalid value for LTGCDAsyncSocketSSLProtocolVersionMin. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for LTGCDAsyncSocketSSLProtocolVersionMin."]];
		return;
	}
	
	// 5. GCDAsyncSocketSSLProtocolVersionMax
	
	value = [tlsSettings objectForKey:LTGCDAsyncSocketSSLProtocolVersionMax];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for LTGCDAsyncSocketSSLProtocolVersionMax. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for LTGCDAsyncSocketSSLProtocolVersionMax."]];
		return;
	}
	
	// 6. GCDAsyncSocketSSLSessionOptionFalseStart
	
	value = [tlsSettings objectForKey:LTGCDAsyncSocketSSLSessionOptionFalseStart];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for LTGCDAsyncSocketSSLSessionOptionFalseStart. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for LTGCDAsyncSocketSSLSessionOptionFalseStart."]];
		return;
	}
	
	// 7. GCDAsyncSocketSSLSessionOptionSendOneByteRecord
	
	value = [tlsSettings objectForKey:LTGCDAsyncSocketSSLSessionOptionSendOneByteRecord];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for LTGCDAsyncSocketSSLSessionOptionSendOneByteRecord."
		             @" Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for LTGCDAsyncSocketSSLSessionOptionSendOneByteRecord."]];
		return;
	}
	
	// 8. GCDAsyncSocketSSLCipherSuites
	
	value = [tlsSettings objectForKey:LTGCDAsyncSocketSSLCipherSuites];
	if ([value isKindOfClass:[NSArray class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for LTGCDAsyncSocketSSLCipherSuites. Value must be of type NSArray.");
		
		[self closeWithError:[self otherError:@"Invalid value for LTGCDAsyncSocketSSLCipherSuites."]];
		return;
	}
	...
	{
		NSAssert(NO, @"Invalid value for LTGCDAsyncSocketSSLDiffieHellmanParameters. Value must be of type NSData.");
		
		[self closeWithError:[self otherError:@"Invalid value for LTGCDAsyncSocketSSLDiffieHellmanParameters."]];
		return;
	}
	#endif
	...
	if (value)
	{
		NSAssert(NO, @"Security option unavailable - kCFStreamSSLLevel"
		             @" - You must use LTGCDAsyncSocketSSLProtocolVersionMin & LTGCDAsyncSocketSSLProtocolVersionMax");
	...
	sslPreBuffer = [[LTGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
- (void)ssl_continueSSLHandshake
{
	...
	else if (status == errSSLPeerAuthCompleted)
	{
		...
		else
		{
			...
			NSString *msg = @"LTGCDAsyncSocketManuallyEvaluateTrust specified in tlsSettings,"
...
- (void)cf_startTLS
{
	...
	NSAssert([currentRead isKindOfClass:[LTGCDAsyncSpecialPacket class]], @"Invalid read packet for startTLS");
	NSAssert([currentWrite isKindOfClass:[LTGCDAsyncSpecialPacket class]], @"Invalid write packet for startTLS");
...
+ (void)startCFStreamThreadIfNeeded
{
	...
	dispatch_once(&predicate, ^{
		...
		cfstreamThreadSetupQueue = dispatch_queue_create("LTGCDAsyncSocket-CFStreamThreadSetup", DISPATCH_QUEUE_SERIAL);
	});
...
{
	[[NSThread currentThread] setName:LTGCDAsyncSocketThreadName];
...
+ (void)scheduleCFStreams:(LTGCDAsyncSocket *)asyncSocket
{
	LogTrace();
...
+ (void)unscheduleCFStreams:(LTGCDAsyncSocket *)asyncSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == cfstreamThread, @"Invoked on wrong thread");
...
{
	LTGCDAsyncSocket *asyncSocket = (__bridge LTGCDAsyncSocket *)pInfo;

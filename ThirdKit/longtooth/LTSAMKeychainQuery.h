...
NS_ASSUME_NONNULL_BEGIN
	...
	#define LTSAMKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define LTSAMKEYCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef LTSAMKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, LTSAMKeychainQuerySynchronizationMode) {
	LTSAMKeychainQuerySynchronizationModeAny,
	LTSAMKeychainQuerySynchronizationModeNo,
	LTSAMKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface LTSAMKeychainQuery : NSObject
...
@property (nonatomic) LTSAMKeychainQuerySynchronizationMode synchronizationMode;
#endif

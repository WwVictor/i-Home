...
extern NSString *const LTGCDAsyncUdpSocketException;
extern NSString *const LTGCDAsyncUdpSocketErrorDomain;

extern NSString *const LTGCDAsyncUdpSocketQueueName;
extern NSString *const LTGCDAsyncUdpSocketThreadName;

typedef NS_ENUM(NSInteger, LTGCDAsyncUdpSocketError) {
	LTGCDAsyncUdpSocketNoError = 0,          // Never used
	LTGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	LTGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	LTGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	LTGCDAsyncUdpSocketClosedError,          // The socket was closed
	LTGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class LTGCDAsyncUdpSocket;

@protocol LTGCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(LTGCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;
...
**/
- (void)udpSocket:(LTGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(LTGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(LTGCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * 
**/
typedef BOOL (^LTGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^LTGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface LTGCDAsyncUdpSocket : NSObject
...
- (instancetype)initWithDelegate:(nullable id <LTGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id <LTGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;

#pragma mark Configuration

- (nullable id <LTGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id <LTGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id <LTGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id <LTGCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id <LTGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id <LTGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)setSendFilter:(nullable LTGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable LTGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable LTGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable LTGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
